...
public class SparkSqlLineageTest extends AbstractSqlLineageTest {
    ...
    public void testInsertInto() throws Exception {
        String sql = "insert overwrite table db2.Demo partition(dt='20231010') " +
                "select concat(a.COL1, '-', a.COL2), a.row_num, substr(current_timestamp(),1,19) AS data_store_time\n from db1.test a where ds='201912'";
