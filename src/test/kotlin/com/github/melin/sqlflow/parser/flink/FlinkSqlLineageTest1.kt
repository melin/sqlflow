...
import com.github.melin.sqlflow.metadata.SimpleMetadataService
    ...
    fun testInsertInto() {
        ...
        for (statement in statements) {
            if (statement is CreateTable) {
                ...
                val table = SchemaTable("default", statement.tableId.getFullTableName(), columns)
                tables.add(table)
            }
        }
        ...
        val table = SchemaTable("default", "buy_cnt_per_hour", columns);
        ...
        for (statement in statements) {
            if (statement is InsertTable) {
                ...
                val statementAnalyzer = StatementAnalyzer(analysis, metadataService, SQL_PARSER)
