...
import static com.github.melin.sqlflow.formatter.SqlFormatter.formatName;
import static com.github.melin.sqlflow.formatter.SqlFormatter.formatSql;
...
public final class ExpressionFormatter {
    ...
    public static class Formatter extends AstVisitor<String, Void> {
        ...
        @Override
        public String visitCurrentCatalog(CurrentCatalog node, Void context) {
            return "CURRENT_CATALOG";
        }

        @Override
        public String visitCurrentSchema(CurrentSchema node, Void context) {
        ...
        @Override
        public String visitWindowOperation(WindowOperation node, Void context) {
        ...
        @Override
        public String visitLabelDereference(LabelDereference node, Void context) {
    ...
    private static String formatFrame(WindowFrame windowFrame) {
        ...
        windowFrame.getPattern().ifPresent(pattern ->
                builder.append(" PATTERN(")
                        .append(RowPatternFormatter.formatPattern(pattern))
                        .append(")"));
